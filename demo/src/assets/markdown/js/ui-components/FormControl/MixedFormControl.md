...
const validationSchema = z.object({
    ...
    singleCheckbox: z.literal(true, { errorMap: () => ({ message: 'You must tick this!' })}),
    ...
    switcher: z.literal(true, { errorMap: () => ({ message: 'You must turn this on!' })}),
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
            <FormItem
                ...
                <Controller
                    ...
                    control={control}
                    render={({ field }) =>
                        <Input type="text" autoComplete="off" placeholder="Input" {...field} />
                    } />
            </FormItem>
            <FormItem
                asterisk
            ...
            <FormItem
                ...
                <Controller
                    ...
                    control={control}
                    render={({ field }) =>
                        <Select isMulti componentAs={CreatableSelect} options={options} {...field} />
                    } />
            </FormItem>
            <FormItem
                asterisk
            ...
            <FormItem
                ...
                <FormItem>
                    <Button type="reset" className="ltr:mr-2 rtl:ml-2" onClick={() => reset()}>
                        Reset
                    </Button>
