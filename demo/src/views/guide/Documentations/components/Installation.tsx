    ...
    return (
        <>
            ...
            <div className="mt-8">
                ...
                <p>
                    After extracting the downloaded .zip file, you'll find two folders <strong>TypeScript</strong> and <strong>JavaScript</strong>. Each folder contains the following sub-directories:
                </p>
                <ul>
                    <li>
                        <strong>demo</strong>
